...
function ITEM:Unequip(client, bPlaySound, bRemoveItem)
    ...
    // make sure all attachments are gone too
    for _, v in pairs(client:GetCharacter():GetInventory():GetItems()) do
        if (v.isAttachment and v:GetData("equip") and v.attachmentWeapon == self.class) then
...
ITEM:AddContrabandClassification("95R")
ITEM:MakeIllegal()