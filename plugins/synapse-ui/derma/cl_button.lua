...
local buttonPadding = ScreenScale(12)
...
function PANEL:Init()
    self:SetFont("synapse.nagonia.4")
    ...
    self.currentBackgroundAlpha = self.backgroundAlpha / 1.25
end
...
function PANEL:PaintBackground(width, height)
    ...
    surface.SetDrawColor(0, 0, 0, self.currentBackgroundAlpha)
...
function PANEL:OnCursorEntered()
    ...
    LocalPlayer():EmitSound("synapse.button.hover")
end
...
function PANEL:OnCursorExited()
    ...
    self:CreateAnimation(0.15, {
        target = {currentBackgroundAlpha = self.backgroundAlpha / 1.25}
    })
end
...
function PANEL:OnMousePressed(code)
    ...
    LocalPlayer():EmitSound("synapse.button.press")
...
vgui.Register("synapse.button", PANEL, "DButton")

-- selection menu button
DEFINE_BASECLASS("synapse.button")
PANEL = {}
...
vgui.Register("ixMenuSelectionButton", PANEL, "synapse.button")
...
vgui.Register("HG.MenuSelectionList", PANEL, "DPanel")
