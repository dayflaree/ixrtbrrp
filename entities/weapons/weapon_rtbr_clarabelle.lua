...
SWEP.ViewModel		= "models/weapons/clarabelle/c_clarabelle.mdl"
SWEP.WorldModel		= "models/weapons/clarabelle/w_clarabelle.mdl"
...
SWEP.Primary.ClipMax		= 5 -- for TTT

SWEP.FireRate		= 0.01
SWEP.BulletCount	= 7
SWEP.BulletDamage	= 10
SWEP.BulletSpread 	= Vector( 0.11607, 0.11607, 0.11607 )

SWEP.CrosshairX		= 0.25
SWEP.CrosshairY		= 0.0
SWEP.HoldType		= "shotgun"

SWEP.ShootSound		= "Weapon_Shotgun2.Fire_Player"
SWEP.DeploySound	= "Weapon_Shotgun.Draw"
