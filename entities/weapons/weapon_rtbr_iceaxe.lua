...
SWEP.PrintName		= "#rtbr.weapons.iceaxe"
SWEP.Category		= "Raising The Bar: Redux"

if CLIENT then
	SWEP.WepSelectIcon	= surface.GetTextureID("sprites/weapons/iceaxe.vmt")
end

SWEP.ViewModel		= "models/weapons/rtbriceaxe/c_iceaxe.mdl"
SWEP.WorldModel		= "models/weapons/rtbriceaxe/w_iceaxe.mdl"
...
SWEP.SwingSound		= "RTBR_Weapon_IceAxe.Swing"
SWEP.DeploySound	= "RTBR_Weapon_IceAxe.Draw"
SWEP.HitSound		= "RTBR_Weapon_IceAxe.Melee_Hit"
